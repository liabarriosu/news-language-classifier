...
Original file is located at
    https://colab.research.google.com/drive/17RxYVSgtuxi2TAirzWZCq8QF0lqYDQBk
"""
...
#leer archivo
df = pd.read_excel('/content/drive/MyDrive/Trabajos freelance/Tedic -Lía Barrios/Dataset tedic.xlsx')
...
def rate_content(text, emotional_vocab, excessive_adj, violent_vocab):
    """Califica el contenido en una escala de 1 a 5 según la presencia e intensidad de los vocabularios"""
    if not text:
        return 1
    ...
    # Puntuación por contenido violento (mayor peso)
    if violent_count > 0:
...
# Función para identificar qué categorías están presentes
